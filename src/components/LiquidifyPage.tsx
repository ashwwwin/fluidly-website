  ...
  return (
    <div className="flex w-full flex-col h-full">
      ...
      <div className="flex flex-col min-h-[calc(100vh-250px)] items-center justify-center">
        ...
        {selectedContract && (
          <>
            <div className="p-3 bg-white bg-opacity-5 rounded-md">
              <div className="text-white mb-5 flex-col gap-y-2.5 flex items-center">
                <span className="select-none">
                  {selectedContract} to deposit
                </span>
                <input
                ...
                {selectedContract == "ERC721" && (
                  <>
                    <input
                      placeholder={`Token ids to deposit (eg. 3583,1218)`}
                      className="text-white bg-white bg-opacity-10 w-[350px] outline-none py-1.5 px-2 rounded-md"
                    />
                    <span className="text-xs -mt-1 select-none w-[350px] text-center">
                      Token ids to deposit are NFTs that belong to you that you
                ...
                <span className="mt-8 select-none">ERC20 to create</span>
                <input
            ...
            <span
              ...
              className="flex gap-x-2 text-white hover:opacity-100 cursor-pointer select-none opacity-60 text-[15px] w-full items-center justify-center mt-2 text-center"
            >
